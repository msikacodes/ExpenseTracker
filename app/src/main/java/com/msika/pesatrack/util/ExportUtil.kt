package com.msika.pesatrack.util
...
fun shareCsvFile(context: Context, file: File, strings: AppStrings) {
    ...
    context.startActivity(Intent.createChooser(intent, strings.shareExpenses))
}
